...
const EventDetailModal = lazy(() => import('./components/modals/EventDetailModal').then(m => ({ default: m.EventDetailModal })));
const AdminLoginPage = lazy(() => import('./pages/AdminLoginPage').then(m => ({ default: m.AdminLoginPage })));

const CommunityLandingPage = lazy(() => import('./pages/CommunityLandingPage').then(m => ({ default: m.CommunityLandingPage })));
const EventSubmissionPage = lazy(() => import('./pages/EventSubmissionPage').then(m => ({ default: m.EventSubmissionPage })));
const EventsLandingPage = lazy(() => import('./pages/EventsLandingPage').then(m => ({ default: m.EventsLandingPage })));
const EventPublicDetailPage = lazy(() => import('./pages/EventPublicDetailPage').then(m => ({ default: m.EventPublicDetailPage })));
const GalleryIndexPage = lazy(() => import('./pages/GalleryIndexPage').then(m => ({ default: m.GalleryIndexPage })));
const GalleryAlbumPage = lazy(() => import('./pages/GalleryAlbumPage').then(m => ({ default: m.GalleryAlbumPage })));
const NewsIndexPage = lazy(() => import('./pages/NewsIndexPage').then(m => ({ default: m.NewsIndexPage })));
const NewsArticlePage = lazy(() => import('./pages/NewsArticlePage').then(m => ({ default: m.NewsArticlePage })));
const SponsorLandingPage = lazy(() => import('./pages/SponsorLandingPage').then(m => ({ default: m.SponsorLandingPage })));
const DocsPage = lazy(() => import('./pages/DocsPage').then(m => ({ default: m.DocsPage })));
const TenantDirectoryPage = lazy(() => import('./pages/TenantDirectoryPage').then(m => ({ default: m.TenantDirectoryPage })));
const CommunityDirectoryPage = lazy(() => import('./pages/CommunityDirectoryPage').then(m => ({ default: m.CommunityDirectoryPage })));
const ExhibitionsLandingPage = lazy(() => import('./pages/ExhibitionsLandingPage').then(m => ({ default: m.ExhibitionsLandingPage })));
...
const PublicLetterViewer = lazy(() => import('./pages/PublicLetterViewer').then(m => ({ default: m.PublicLetterViewer })));
