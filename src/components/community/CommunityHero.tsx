    ...
    >
      ...
      {heroImageUrl ? (
        ...
        <>
          ...
          <div
            className="absolute inset-0"
            style={{ background: 'linear-gradient(135deg, var(--brand-violet) 0%, var(--brand-ink) 40%, var(--brand-violet-soft) 100%)' }}
          />
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.15) 0%, rgba(124, 108, 242, 0.08) 100%)' }}
          />
        </>
      )}
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-center px-4 py-24 sm:px-6">
        <div className="grid w-full gap-12 lg:grid-cols-[55fr_45fr] lg:items-center">

          {/* LEFT COLUMN: text content */}
          <div className="lg:text-left text-center">
            <RevealSection as="div" className="max-w-none">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/14 bg-white/8 px-5 py-2.5 text-[12px] font-bold tracking-wider text-white/80 backdrop-blur-sm">
          ...
          <div className="hidden lg:flex items-center justify-center">
            {heroImageUrl ? (
              <img src={imgUrl(heroImageUrl, { w: 640, q: 80 })} alt="" className="max-h-[500px] w-auto rounded-[2rem] object-cover shadow-2xl" />
            ) : (
              <div className="w-full max-w-sm rounded-[2rem] p-12" style={{ background: 'linear-gradient(135deg, var(--brand-violet) 0%, var(--brand-ink) 100%)' }}>
                <div className="aspect-square w-full rounded-2xl opacity-[0.06]" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='nf'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23nf)'/%3E%3C/svg%3E")` }} />
              </div>
            )}
          </div>
