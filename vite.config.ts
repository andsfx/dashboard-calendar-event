...
export default defineConfig({
  ...
  build: {
    ...
    minify: 'terser',
    terserOptions: {
      compress: { passes: 3, booleans_as_integers: true, pure_getters: true, keep_fargs: false, unsafe: true, unsafe_comps: true, unsafe_Function: true, unsafe_math: true, unsafe_symbols: true },
